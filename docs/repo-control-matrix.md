...
| `velocity-architecture` | Framework and research authority | `https://zencloudau.github.io/velocity-architecture/` | `https://github.com/ZenCloudAU/velocity-architecture` | README Start Here, site map, research reader, rendered article pages, deployment docs, ecosystem routing | P1 complete / monitor |
